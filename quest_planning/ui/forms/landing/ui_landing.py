...
class Ui_LandingPage(object):
    def setupUi(self, LandingPage):
        ...
        self.btn_about = QPushButton(self.frame_btns)
        self.btn_about.setObjectName(u"btn_about")

        self.horizontalLayout_3.addWidget(self.btn_about)

        self.btn_start = QPushButton(self.frame_btns)
        ...
        self.horizontalSpacer_7 = QSpacerItem(60, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.horizontalSpacer_8 = QSpacerItem(60, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)
    ...
    def retranslateUi(self, LandingPage):
        ...
        self.btn_about.setText(QCoreApplication.translate("LandingPage", u"Documentation", None))
        self.btn_start.setText(QCoreApplication.translate("LandingPage", u"Start", None))
        self.btn_start.setProperty("btnRole", QCoreApplication.translate("LandingPage", u"primary", None))
