...
pcm_dir = root_dir / "pcm"
pcm_env_dir = pcm_dir / "env_pcm"
...
def get_install_script_path():
    if sys.platform.startswith("win"):
        return pcm_dir / "install_pcm.bat"

    return pcm_dir / "install_pcm.sh"
...
def uninstall_pcm(*, missing_ok: bool = True) -> None:
    ...
    expected_parent = (pcm_dir).resolve()
