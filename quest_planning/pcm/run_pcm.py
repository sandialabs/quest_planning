...
class PCM_Exporter:
    ...
    def execute_pcm(self, export_years):
        """
        Create PCM_Data folder, export per-year inputs, and execute PCM.
        ...
        storage CSV files, and then runs QuESt PCM.
        ...
        for year in export_years:
            ...
            try:
                ...
                print(f"PCM run unsuccessful for year {year}, only PCM data is exported")
    ...
    def export_yaml_file(self, folder_path, current_year):
        ...
        pcm_hours = int(self.config.get("pcm_hours", 8760))
    ...
    def run_PCM(self, folder_path, input_yaml_path, input_data_path, current_year):
        ...
        proc.wait()
        os.remove(temp_script)
        print(f"PCM simulation for year {current_year} complete")
